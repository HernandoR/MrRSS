...
const zh: TranslationMessages = {
  article: {
    ...
    chat: {
      ...
      selectProfile: '选择 AI 配置',
      summarySuggestions: '摘要总结',
      questionSuggestions: '推荐问题',
      customSuggestions: '自定义问题',
      promptConciseSummary: '用一句话总结这篇文章。',
      promptKeyPoints: '列出这篇文章的关键要点。',
      promptDetailedSummary: '详细总结这篇文章。',
      promptMainContent: '这篇文章的主要内容是什么？',
      promptKeyPeople: '文章提到了哪些关键人物？',
      promptMainViews: '文章有哪些主要观点？',
      promptKeyInformation: '有哪些重要事实或数据值得记住？',
    ...
    list: {
      ...
      noFavorites: '收藏夹还是空的',
      noFavoritesHint: '收藏感兴趣的文章，之后可以在这里快速找到。',
    },
    navigation: {
  ...
  modal: {
    ...
    feed: {
      ...
      contentOptions: '全文提取',
      contentOptionsHelp:
        '仅用于当前订阅源。选择器留空时自动提取。单独保存此处设置后，重新获取文章全文即可生效。',
      ...
      feedRefreshFailed: '重新加载订阅源失败',
      reloadFeed: '重新加载订阅源',
      reloadingFeed: '正在重新加载...',
      ...
      loadFailedKeepingData: '刷新失败，当前显示上次成功加载的订阅源。',
      retry: '重试',
      proxy: '订阅代理',
  ...
  setting: {
    ...
    ai: {
      ...
      endpoint: '端点',
      aiEndpointDesc:
        '完整 API 地址：/chat/completions、Claude /v1/messages，或 Gemini /v1beta（使用下方模型名）',
      ...
      quickPromptsHint: '按回车或“添加”保存问题，重复内容会被忽略。',
      removeQuickPrompt: '删除问题',
    ...
    content: {
      ...
      translationOnlyMode: '只显示译文',
      translationOnlyModeDesc: '翻译完成后隐藏对应原文；按需翻译时仅隐藏已翻译的标题或段落',
    ...
    freshrss: {
      ...
      syncStarted: '同步已开始',
      username: '用户名',
      usernameDesc: '在服务器中配置的 Google Reader API 用户名',
    ...
    rule: {
      ...
      importRules: '导入规则',
      importConfirm:
        '将 {count} 条规则追加至现有列表？会保留启用状态，并在后续刷新时生效；此次不立即处理已有文章。',
      importSuccess: '已导入 {count} 条规则',
      invalidBackup: 'MrRSS 规则备份格式无效或不受支持，未导入任何规则。',
      backupTooLarge: '规则备份超过 5 MB 限制。',
      importFailed: '无法导入规则，请重新加载设置后再试。',
      noRules: '暂无规则',
    ...
    update: {
      ...
      currentVersion: '当前版本',
      downloadFailedHelp: '自动下载未完成。您可以检查网络或代理设置后重试，也可以手动下载更新。',
      downloadManually: '前往发布页手动下载',
      downloadNetworkError: '无法连接到 GitHub 下载更新，请检查网络或代理设置。',
      downloadProxyError: '代理设置无效，请检查网络设置后重试。',
      downloadServerError: 'GitHub 下载服务暂时不可用，请稍后重试。',
      downloadTimeout: '下载更新超时，请检查网络或代理设置后重试。',
      installFailed: '安装失败',
  ...
  sidebar: {
    categoryActions: {
      ...
      unsubscribeConfirm:
        '取消“{name}”及子分类中的全部 {count} 个订阅？其文章（包括收藏）将被删除。',
      done: '分类已更新',
      failed: '无法完成分类操作，请刷新后再试。',
    },
    order: {
      sort: '分类和订阅排序',
      manual: '自定义顺序',
      ...
      pinItem: '置顶到当前层级',
      unpinItem: '取消置顶',
      manualRequired: '请先选择“自定义顺序”再拖动，置顶项目会保留在顶部。',
      dragCategory: '拖动调整同级分类顺序',
      saved: '分类顺序已保存',
    },
    activity: {
      addFeed: '添加订阅',
