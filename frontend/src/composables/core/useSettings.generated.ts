...
export function generateInitialSettings(): SettingsData {
  return {
    ...
    freshrss_provider: settingsDefaults.freshrss_provider,
...
export function parseSettingsData(data: Record<string, string>): SettingsData {
  return {
    ...
    ai_chat_response_preferences: data.ai_chat_response_preferences || settingsDefaults.ai_chat_response_preferences,
    ...
    freshrss_provider: data.freshrss_provider || settingsDefaults.freshrss_provider,
    ...
    translation_trigger_mode: data.translation_trigger_mode || settingsDefaults.translation_trigger_mode,
...
export function buildAutoSavePayload(settingsRef: Ref<SettingsData>): Record<string, string> {
  return {
    ...
    ai_chat_quick_prompts: settingsRef.value.ai_chat_quick_prompts ?? settingsDefaults.ai_chat_quick_prompts,
    ai_chat_response_preferences: settingsRef.value.ai_chat_response_preferences ?? settingsDefaults.ai_chat_response_preferences,
    ...
    confirm_mark_as_read: (settingsRef.value.confirm_mark_as_read ?? settingsDefaults.confirm_mark_as_read).toString(),
    ...
    freshrss_provider: settingsRef.value.freshrss_provider ?? settingsDefaults.freshrss_provider,
    ...
    remember_article_position: (settingsRef.value.remember_article_position ?? settingsDefaults.remember_article_position).toString(),
    ...
    sidebar_category_order: settingsRef.value.sidebar_category_order ?? settingsDefaults.sidebar_category_order,
    sidebar_pinned_items: settingsRef.value.sidebar_pinned_items ?? settingsDefaults.sidebar_pinned_items,
    ...
    translation_trigger_mode: settingsRef.value.translation_trigger_mode ?? settingsDefaults.translation_trigger_mode,
    ...
    update_check_enabled: (settingsRef.value.update_check_enabled ?? settingsDefaults.update_check_enabled).toString(),
